select wp.vorname, wp.nachname, wmf.datum_von, wmf.datum_bis, wmf.cnt_mtg, wmf.rn_mtg,
	wp.pers_id, wp.anrede, wp.titel_vorne, wp.titel_hinten, 
	...
	concat_ws('; ', wp.email1, wp.email2, wp.email3, wp.email4, wp.email5) as email,
	concat_ws('; ', wp.rechnungs_email1, wp.rechnungs_email2, wp.rechnungs_email3) as rechnungs_email,
...
inner join main.w_mitglied_full wmf on wp.pers_id = wmf.uns_pers_id
order by wmf.cnt_mtg desc, wp.pers_id, wmf.datum_bis desc