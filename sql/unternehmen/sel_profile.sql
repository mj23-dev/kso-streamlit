select wu.vollname_der_firma, wu.kurzbezeichnung,  wu.uns_id, wu.cnt_pers, 
	case when wu.seite not like 'http%' and wu.seite not like 'www%' then '-' else wu.seite end as seite, 
	...
	wu.heaf, wu.hauptunternehmen_id, wu.rechnungsadr_full, wu.registrierungsstatus, wu.compass_id, wu.uns_id as id
from main.w_uns wu