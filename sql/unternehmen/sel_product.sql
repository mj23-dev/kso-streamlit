select wup.product_name, 
	...
	wu.rechtsform, wu.onace_sh_de1, wu.onace_sh_de2, wu.onace_sh_de3, wu.onace_sh_de4, wu.onace_sh_de5, wu.code5 as onace_code5,
	wu.tatigkeitsbeschreibung,
...
from main.w_uns wu
inner join main.w_uns_prod wup 
on wu.uns_id = wup.uns_id