...
gb.configure_selection(selection_mode="single", use_checkbox=True, suppressRowClickSelection=True) # Enable single selection (multiple)
gb.configure_default_column(enablePivot=True, enableValue=True, enableRowGroup=True)

gb.configure_column(field='vollname_der_firma', header_name='Vollname', pinned='left', filter=ag_grid.filters.multi, headerCheckboxSelection = True)
gb.configure_column(field='uns_id', header_name='Id', filter=ag_grid.filters.multi)
gb.configure_column(field='juradr_land', header_name='Land', filter=ag_grid.filters.multi)
gb.configure_column(field='juradr_bundesland', header_name='Bundesland', filter=ag_grid.filters.multi)
gb.configure_column(field='rechtsform', header_name='Rechtsform', filter=ag_grid.filters.multi)
gb.configure_column(field='product_name_agg', header_name='Product', filter=ag_grid.filters.multi)
gb.configure_column(field='registrierungsstatus', header_name='Registrierungsstatus', filter=ag_grid.filters.multi)
gb.configure_column(field='akt_titel', header_name='Last aktivitaten', filter=ag_grid.filters.multi)
gb.configure_column(field='heaf', header_name='Heaf', filter=ag_grid.filters.multi)
