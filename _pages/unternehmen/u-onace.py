...
title = 'unternehmen'
st.subheader("🎯 ONACE (ÖNACE - Klassifikation der Wirtschaftstätigkeiten)")
...
gb.configure_column(field='onace_sh_de2', header_name='ONACE L2', filter=ag_grid.filters.multi, width=200, rowGroup=True, hide=True)
gb.configure_column(field='onace_sh_de3', header_name='ONACE L3', filter=ag_grid.filters.multi, width=200, rowGroup=True, hide=True)
gb.configure_column(field='onace_sh_de4', header_name='ONACE L4', filter=ag_grid.filters.multi, width=200, rowGroup=True, hide=True)
...
gb.configure_column(field='rechnungsadr_full', header_name='Address', filter=ag_grid.filters.multi)
