...
title = 'unternehmen'
st.subheader("💶 Produkt und Dienstleistungskategorien (Compass)")
...
gb.configure_column(field='vollname_der_firma', header_name='Voller Name', filter=True, minWidth=200, maxWidth=500)
gb.configure_column(field='uns_id', header_name='ID Uns', filter=True, minWidth=120, maxWidth=120)
