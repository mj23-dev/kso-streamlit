...
gb.configure_column(field='vollname_der_firma', header_name='Oberste Struktureinheit', pinned='left', filter=True, headerCheckboxSelection = True)
gb.configure_column(field='cnt_pers', header_name='Cnt Pers', pinned='left', filter=True, width=100)
gb.configure_column(field='vor_nachname', header_name='Vor- und Nachname', pinned='left', filter=True, width=200)
gb.configure_column(field='prsd', header_name='Präsidium', filter=True, width=100)
gb.configure_column(field='vrst', header_name='Vorstand', filter=True, width=100)
gb.configure_column(field='gnrl', header_name='Generalsekretär', filter=True, width=100)
gb.configure_column(field='rchn', header_name='Rechnungsprüfer', filter=True, width=100)
gb.configure_column(field='pos1', header_name='Position1', filter=True, width=200)
gb.configure_column(field='pos2', header_name='Position2', filter=True, width=200)
gb.configure_column(field='email', header_name='Email', filter=True, width=200)
gb.configure_column(field='juradr_bundesland', header_name='Bundesland', filter=True, width=150)
gb.configure_column(field='juradr_full', header_name='Adresse', filter=True, width=250)
gb.configure_column(field='vorname', header_name='Vorname', filter=True, width=150)
gb.configure_column(field='nachname', header_name='Nachname', filter=True, width=150)
gb.configure_column(field='uns_id', header_name='ID Uns', filter=True, width=140)
...
if len(selected_df) > 0:
    ...
    with st.spinner("⏳ Loading ..."):
        ...
        with tab1:
            ...
            gb1.configure_column(field='uns_mitg', header_name='Uns Mtg', filter=True, width=100)
        ...
        #     gb3.configure_column(field='datum_titel', header_name='Datum | Titel', pinned='left', filter=True, width=250)
        ...
        #         """)
        #                         )
        #     gb3.configure_column(field='format', header_name='Format', filter=True, width=100)
        #     gb3.configure_column(field='bundesland', header_name='Place', filter=True, width=150)
        #     gb3.configure_column(field='akt_org', header_name='Organizer', filter=True, width=300)
        #     gb3.configure_column(field='akt_spn', header_name='Sponsor', filter=True, width=300)
        #     gb3.configure_column(field='aktivitaten_id', header_name='ID', filter=True, width=120)
        #     gb3.configure_column(field='adr_full', header_name='Adress', filter=True, width=300)
        #
