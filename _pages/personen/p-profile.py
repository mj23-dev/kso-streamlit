...
gb.configure_column(field='pers_mitg', header_name='MG', filter=True, width=80)
gb.configure_column(field='pers_mitg_maxd', header_name='Letzte MG Data', type=["customDateTimeFormat"],custom_format_string='yyyy-MM-dd', filter=True, width=120)
...
gb.configure_column(field='email1', header_name='Email1', filter=True, width=150)
gb.configure_column(field='email2', header_name='Email2', filter=True, width=150)
gb.configure_column(field='email3', header_name='Email3', filter=True, width=150)
gb.configure_column(field='email4', header_name='Email4', filter=True, width=150)
gb.configure_column(field='email5', header_name='Email5', filter=True, width=150)
gb.configure_column(field='rechnungs_email1', header_name='RchnEmail1', filter=True, width=150)
gb.configure_column(field='rechnungs_email2', header_name='RchnEmail2', filter=True, width=150)
gb.configure_column(field='rechnungs_email3', header_name='RchnEmail3', filter=True, width=150)
...
gb.configure_column(field='akt_titel', header_name='Letzte Akt Titel', filter=True, width=200)
