...
gb.configure_column(field='datum_von', header_name='Data Von', type=["customDateTimeFormat"], custom_format_string='yyyy-MM-dd', filter=ag_grid.filters.multi, width=120)
gb.configure_column(field='datum_bis', header_name='Data Bis', type=["customDateTimeFormat"], custom_format_string='yyyy-MM-dd', filter=ag_grid.filters.multi, width=120)
gb.configure_column(field='cnt_mtg', header_name='Cnt MG', filter=ag_grid.filters.number, width=100)
gb.configure_column(field='rn_mtg', header_name='Rn MG', filter=ag_grid.filters.number, width=100)
...
gb.configure_column(field='email', header_name='Email', filter=ag_grid.filters.multi, width=150)
gb.configure_column(field='rechnungs_email', header_name='RchnEmail', filter=ag_grid.filters.multi, width=150)
...
gb.configure_column(field='akt_titel', header_name='Letzte Akt ID', filter=ag_grid.filters.multi, width=200)
    ...
    with st.spinner("⏳ Loading ..."):
        ...
        with tab1:
            ...
            gb1.configure_column(field='aktivitaten_id', header_name='Letzte Akt ID', filter=ag_grid.filters.multi,
                                width=120)
            gb1.configure_column(field='akt_titel', header_name='Letzte Akt ID', filter=ag_grid.filters.multi)
            ...
            gb1.configure_column(field='pers_id', header_name='ID Pers', filter=ag_grid.filters.multi, width=120)
