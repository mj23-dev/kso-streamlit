...
gb.configure_column(field='datum_titel', header_name='Data | Titel', pinned='left', filter=True, width=400, minWidth=200, maxWidth=1000)
...
gb.configure_column(field='cnt_pers', header_name='Cnt Pers', filter=True, maxWidth=100)
gb.configure_column(field='cnt_uns', header_name='Cnt Uns', filter=True, maxWidth=100)
...
gb.configure_column(field='adr_full', header_name='Adresse der Veranstaltung', filter=True, width=200, minWidth=100, maxWidth=500)
...
if len(selected_df) > 0:
    ...
    with st.spinner("⏳ Loading ..."):
        ...
        with tab2:
            ...
            gb2.configure_column(field='last_akt_id', header_name='Last Akt ID', filter=True, maxWidth=120)
